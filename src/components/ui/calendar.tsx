  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-orange-400 text-white hover:bg-orange-300 hover:text-white focus:bg-orange-500 focus:text-orange-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
